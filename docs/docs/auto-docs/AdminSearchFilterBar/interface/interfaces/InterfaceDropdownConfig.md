...
Defined in: [src/types/AdminSearchFilterBar/interface.ts:81](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/AdminSearchFilterBar/interface.ts#L81)
...
Defined in: [src/types/AdminSearchFilterBar/interface.ts:61](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/AdminSearchFilterBar/interface.ts#L61)
