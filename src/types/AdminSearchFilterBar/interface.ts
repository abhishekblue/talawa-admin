/**
 * Type definitions for the AdminSearchFilterBar component.
 * This file contains TypeScript interfaces for the AdminSearchFilterBar component,
 * which provides a unified search and filter interface across multiple screens in
 * the Talawa Admin application.
 * @module AdminSearchFilterBar/interface
 */
...
export interface InterfaceSortingOption {
   ...
   * @example "DESCENDING", "hours_DESC", "all"
   */
  value: string;
}
 ...
 * These properties are required for all variants of the AdminSearchFilterBar component.
 */
interface InterfaceAdminSearchFilterBarBase {
  /**
   ...
   * ```
   */
  translations?: InterfaceAdminSearchFilterBarTranslations;
}
...
/**
 * Optional translation overrides for AdminSearchFilterBar component.
 ...
 */
export interface InterfaceAdminSearchFilterBarTranslations {
 ...
 * ```
 */
export type InterfaceAdminSearchFilterBarProps =
